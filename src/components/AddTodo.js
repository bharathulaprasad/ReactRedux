...
function AddTodo() {
  ...
  return (
    ...
    className="space-x-3 mt-12">
      ...
      focus:border-indigo-500 focus:ring-2 transition-colors duration-200 ease-in-out" placeholder="Enter a Todo"
       value={input}
      onChange={(e) => setInput(e.target.value)}
      />
      <button type="submit" className="text-white bg-indigo-600 border-0
